...
install.packages("https://cloud.r-project.org/src/contrib/purrr_0.3.3.tar.gz", type="source", repos=NULL)
install.packages("https://cloud.r-project.org/src/contrib/dplyr_0.8.3.tar.gz", type="source", repos=NULL)
install.packages("https://cloud.r-project.org/src/contrib/readr_1.3.1.tar.gz", type="source", repos=NULL)
...
install.packages("https://cloud.r-project.org/src/contrib/rnaturalearth_0.1.0.tar.gz", type="source", repos=NULL)
install.packages("https://cloud.r-project.org/src/contrib/rnaturalearthdata_0.1.0.tar.gz", type="source", repos=NULL)
install.packages("https://cloud.r-project.org/src/contrib/RColorBrewer_1.1-2.tar.gz", type="source", repos=NULL)
